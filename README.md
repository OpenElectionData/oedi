...
The website for the Open Election Data Initiative. It is built on the [CSIS Jekyll Starter](https://github.com/CSIS-iLab/csis-jekyll-starter) that utilizes gulp, Sass, Autoprefixer, PostCSS, Webpack, imagemin, and Browsersync to speed-up development.
...
This will set the `JEKYLL_ENV` to `production` and use the production config file(s) set in `gulp.config.js` to override default settings.
...
Copyright © 2020 Open Election Data Initiative under the [MIT License](https://github.com/CSIS-iLab/on-the-radar/blob/master/LICENSE).
