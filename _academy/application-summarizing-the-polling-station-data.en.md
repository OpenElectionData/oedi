...
The first row of the file contains the names of the variables. There are six variables in this dataset: PS\_Code, PS\_Name, Region\_Name, District\_Name, Constituency\_Name, and Registered\_Voters.
