...
Si vous voulez effectuer vos propres calculs, voici [la série de données sur la taille]({{ site.url }}/\_assets/academy/exercise/Heights.csv). Les données avec quelques calculs sont disponibles [en Fichier Excel]({{ site.url }}/\_assets/academy/exercise/Heights_calculations.xlsx) ou dans un [Fichier de Calcul Ouvert]({{ site.url }}/\_assets/academy/exercise/Heights_calculations.ods).
