...
Ya tiene los antecedentes, ahora revisemos los datos. **Descargue [aquí]({{ site.url }}/\_assets/academy/exercise/Module_5_Voter_Registration_Data.xlsx)** los datos del registro de votantes de Opendya. Necesitará este archivo para poder realizar el ejercicio.
...
Los cálculos deben verse así: [![Image 26]({{ site.url }}/\_assets/images/academy/module_5/Module_5_Photo_26.png)]({{ site.url }}/\_assets/images/academy/module_5/Module_5_Photo_26.png)
